...
namespace ClassLibrary1
{
    ...
    public partial class Match
    {
        public static List<Match> FromJson(string json) => JsonConvert.DeserializeObject<List<Match>>(json, ClassLibrary1.Converter1.Settings);
    }

    public static class Serialize1
    {
        public static string ToJson(this List<Match> self) => JsonConvert.SerializeObject(self, ClassLibrary1.Converter1.Settings);
    }
